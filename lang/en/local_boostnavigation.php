...
$string['inc_bottomnodeslocation'] = 'below the main section in the nav drawer (similar to the "site administration" item)';
$string['inc_coursenode'] = 'course node';
$string['inc_coursenodes'] = 'course nodes';
$string['inc_coursenodeslocation'] = 'to the course section in the nav drawer (where the items for the course topics are located)';
...
$string['inc_rootnodeslocation'] = 'to the main section in the nav drawer (where the "My courses" item and others are located)';
...
$string['setting_customnodesusagepleasenotecheck'] = 'If the custom node does not show up in Boost\'s nav drawer, please check if all mandatory params are set correctly, if the optional language setting fits to your current Moodle user language and if you other optional paramters apply to your user.';
...
$string['setting_customnodesusagepleasenotetitle'] = 'The title parameter can contain placeholders, for example {coursefullname} to create a node labeled with the current course\'s full name. Placeholders are encapsulated in curly brackets and will be replaced automatically when the custom node is created.';
