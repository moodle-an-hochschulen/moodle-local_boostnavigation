...
$string['setting_showcategorynodestreeheading'] = 'Add {$a->what} in Boost\'s navigation';
$string['setting_showcategorynodestree'] = 'Add {$a->what} in Boost\'s nav drawer';
$string['setting_showcategorynodestree_desc'] = 'Enabling this setting will let users see {$a->what}.';
$string['setting_showcategorynodestreeexplanation'] = 'This option should only be used with a few main categories and two levels maximum. The categories are added dynamically, taking into order and visibility settings you specify.';
