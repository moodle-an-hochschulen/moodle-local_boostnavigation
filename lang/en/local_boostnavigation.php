...
<li><b>Before node key (optional):</b> This setting can be used to specify the node above which the custom node should be placed. In case of a set of nodes made of a parent and one or more children, this setting must be given to each node of the set.</li>
</ul>
Please note:
<ul>
