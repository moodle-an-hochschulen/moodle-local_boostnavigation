...
$string['setting_inserticon'] = 'Display {$a->what} "{$a->which}" icon';
$string['setting_inserticon_desc'] = 'Enabling this setting will display a icon in the {$a->what} "{$a->which}" Boost\'s nav drawer.';
