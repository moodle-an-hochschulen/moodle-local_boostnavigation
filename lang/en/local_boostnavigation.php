...
$string['setting_collapsecoursesectionscoursenode_desc'] = 'Enabling this setting will let users collapse the "Sections" node.';
$string['setting_collapsecoursesectionscoursenode'] = 'Collapse node "Sections"';
$string['setting_collapsecoursesectionscoursenodedefault_desc'] = 'Enabling this setting will collapse the "Sections" node by default. Otherwise, it will be expanded by default. This setting just controls the default for each user when the node is rendered for him for the first time.';
...
$string['setting_collapsecustombottomnodesadminsaccordion_desc'] = 'Enabling this setting will collapse the custom bottom nodes for admins as accordion, this means that only one parent node can be expanded at a time. If a second parent node is expanded, the currently expanded parent node is collapsed automatically. If this setting is disabled, multiple parent nodes can be expanded at a time.';
$string['setting_collapsecustombottomnodesadminsaccordion'] = 'Collapse custom bottom nodes for admins as accordion';
$string['setting_collapsecustombottomnodesadminsdefault_desc'] = 'Enabling this setting will collapse the custom bottom nodes for admins by default. Otherwise, they will be expanded by default. This setting just controls the default for each user when the nodes are rendered for him for the first time.';
...
$string['setting_collapsecustombottomnodesheading'] = 'Collapse custom bottom nodes in Boost\'s nav drawer';
...
$string['setting_collapsecustombottomnodesusersaccordion_desc'] = 'Enabling this setting will collapse the custom bottom nodes for users as accordion, this means that only one parent node can be expanded at a time. If a second parent node is expanded, the currently expanded parent node is collapsed automatically. If this setting is disabled, multiple parent nodes can be expanded at a time.';
$string['setting_collapsecustombottomnodesusersaccordion'] = 'Collapse custom bottom nodes for users as accordion';
$string['setting_collapsecustombottomnodesusersdefault_desc'] = 'Enabling this setting will collapse the custom bottom nodes for users by default. Otherwise, they will be expanded by default. This setting just controls the default for each user when the nodes are rendered for him for the first time.';
...
$string['setting_collapsecustomcoursenodesadminsaccordion_desc'] = 'Enabling this setting will collapse the custom course nodes for admins as accordion, this means that only one parent node can be expanded at a time. If a second parent node is expanded, the currently expanded parent node is collapsed automatically. If this setting is disabled, multiple parent nodes can be expanded at a time.';
$string['setting_collapsecustomcoursenodesadminsaccordion'] = 'Collapse custom course nodes for admins as accordion';
$string['setting_collapsecustomcoursenodesadminsdefault_desc'] = 'Enabling this setting will collapse the custom course nodes for admins by default. Otherwise, they will be expanded by default. This setting just controls the default for each user when the nodes are rendered for him for the first time.';
...
$string['setting_collapsecustomcoursenodesheading'] = 'Collapse custom course nodes in Boost\'s nav drawer';
...
$string['setting_collapsecustomcoursenodesusersaccordion_desc'] = 'Enabling this setting will collapse the custom course nodes for users as accordion, this means that only one parent node can be expanded at a time. If a second parent node is expanded, the currently expanded parent node is collapsed automatically. If this setting is disabled, multiple parent nodes can be expanded at a time.';
$string['setting_collapsecustomcoursenodesusersaccordion'] = 'Collapse custom course nodes for users as accordion';
$string['setting_collapsecustomcoursenodesusersdefault_desc'] = 'Enabling this setting will collapse the custom course nodes for users by default. Otherwise, they will be expanded by default. This setting just controls the default for each user when the nodes are rendered for him for the first time.';
...
$string['setting_collapsecustomnodesadminsaccordion_desc'] = 'Enabling this setting will collapse the custom root nodes for admins as accordion, this means that only one parent node can be expanded at a time. If a second parent node is expanded, the currently expanded parent node is collapsed automatically. If this setting is disabled, multiple parent nodes can be expanded at a time.';
$string['setting_collapsecustomnodesadminsaccordion'] = 'Collapse custom root nodes for admins as accordion';
$string['setting_collapsecustomnodesadminsdefault_desc'] = 'Enabling this setting will collapse the custom root nodes for admins by default. Otherwise, they will be expanded by default. This setting just controls the default for each user when the nodes are rendered for him for the first time.';
...
$string['setting_collapsecustomnodesheading'] = 'Collapse custom root nodes in Boost\'s nav drawer';
...
$string['setting_collapsecustomnodesusersaccordion_desc'] = 'Enabling this setting will collapse the custom root nodes for users as accordion, this means that only one parent node can be expanded at a time. If a second parent node is expanded, the currently expanded parent node is collapsed automatically. If this setting is disabled, multiple parent nodes can be expanded at a time.';
$string['setting_collapsecustomnodesusersaccordion'] = 'Collapse custom root nodes for users as accordion';
$string['setting_collapsecustomnodesusersdefault_desc'] = 'Enabling this setting will collapse the custom root nodes for users by default. Otherwise, they will be expanded by default. This setting just controls the default for each user when the nodes are rendered for him for the first time.';
...
$string['setting_collapsemycoursesnodedefault_desc'] = 'Enabling this setting will collapse the "My courses" node by default. Otherwise, it will be expanded by default. This setting just controls the default for each user when the node is rendered for him for the first time.';
...
$string['setting_insertcustombottomnodesheading'] = 'Insert custom bottom nodes to Boost\'s nav drawer';
...
$string['setting_insertcustomcoursenodesheading'] = 'Insert custom course nodes to Boost\'s nav drawer';
...
$string['setting_insertcustomnodesheading'] = 'Insert custom root nodes to Boost\'s nav drawer';
