...
$string['setting_removecoursenodestechnicalhint'] = 'Technically, this is done by removing the node from the navigation tree. Thus, the node cannot be accessed by other parts of Moodle anymore. In normal Moodle setups, this should hopefully not cause any trouble.';
...
$string['setting_removebadgesnode'] = 'Remove "Badges" node';
$string['setting_removebadgesnode_desc'] = 'Enabling this setting will remove the "Badges" node from Boost\'s nav drawer if there are no badges in the course. Teachers can still always access the badges management page in the course menu (cog menu).';
$string['setting_removecompetenciesnode'] = 'Remove "Competencies" node';
$string['setting_removecompetenciesnode_desc'] = 'Enabling this setting will remove the "Competencies" node from Boost\'s nav drawer if there are no competencies in the course. For teachers, there will be another "Competencies" node added to the course menu (cog menu).';
